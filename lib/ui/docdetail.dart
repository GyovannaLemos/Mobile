...
class DocDetailState extends State<DocDetail> {
  ...
  void _initCtrls() {
    ...
    fqHalfYearCtrl = widget.doc.fqhHalfYear != null
        ? Val.IntToBool(widget.doc.fqhHalfYear)
        : false;
  ...
  void _saveDoc() {
    ...
    widget.doc.fqhHalfYear = Val.BoolToInt(fqHalfYearCtrl);
    widget.doc.fqLessMonth = Val.BoolToInt(fqLessMonthCtrl);
    widget.doc.fqYearMonth = Val.BoolToInt(fqYearMonthCtrl);
  ...
  void _submitForm() {
    ...
    if (!form!.validate()) {
      ...
      showMessage('Some data is invalid. Please corret.');
    }
  }
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        DateUtilsDD.daysAheadAsStr(daysAhed) + ')',
